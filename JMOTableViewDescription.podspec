#
#  Be sure to run `pod spec lint JMOTableViewDescription.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors          = { "jerome Morissard" => "morissardj@gmail.com", "other author" => "email@address.com" }
  # s.author           = 'jerome Morissard', 'other author'
  # s.social_media_url = "http://twitter.com/jerome Morissard"
  ...
  s.source       = { :git => "http://EXAMPLE/JMOTableViewDescription.git", :tag => "0.1" }
  ...
  s.source_files  = 'Classes', 'TableViewDescription/TableViewDescription/*.{h,m}'
